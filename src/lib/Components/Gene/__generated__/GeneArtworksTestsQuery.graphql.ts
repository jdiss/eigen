/**
 * @generated SignedSource<<99d20e3dd7240ac4dbd7be66d0812d49>>
...
export type GeneArtworksTestsQueryVariables = GeneArtworksTestsQuery$variables;
export type GeneArtworksTestsQuery$data = {
  readonly gene: {
    readonly " $fragmentSpreads": FragmentRefs<"GeneArtworks_gene">;
  } | null;
};
export type GeneArtworksTestsQueryResponse = GeneArtworksTestsQuery$data;
export type GeneArtworksTestsQuery = {
  variables: GeneArtworksTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "bb68258f441f7a1195a3c8f255cfab4c",
    "id": null,
    "metadata": {
