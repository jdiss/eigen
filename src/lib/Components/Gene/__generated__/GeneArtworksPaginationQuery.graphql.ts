/**
 * @generated SignedSource<<3165579885bc018b83dcb3beb2d76c12>>
...
export type GeneArtworksPaginationQueryVariables = GeneArtworksPaginationQuery$variables;
export type GeneArtworksPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"GeneArtworks_gene">;
  } | null;
};
export type GeneArtworksPaginationQueryResponse = GeneArtworksPaginationQuery$data;
export type GeneArtworksPaginationQuery = {
  variables: GeneArtworksPaginationQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "707a2eff37fa0796d220e5ee0608f5f4",
    "id": null,
    "metadata": {},
    "name": "GeneArtworksPaginationQuery",
    "operationKind": "query",
