/**
 * @generated SignedSource<<1b8296312be62190c48eee5dcae96cc3>>
...
export type ShowArtistsPreview_show$data = {
  ...
  readonly " $fragmentType": "ShowArtistsPreview_show";
};
export type ShowArtistsPreview_show = ShowArtistsPreview_show$data;
