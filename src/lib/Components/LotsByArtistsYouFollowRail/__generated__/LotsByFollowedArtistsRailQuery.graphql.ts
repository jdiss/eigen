/**
 * @generated SignedSource<<3de8008680e6579a5f3d2afd297aff78>>
...
export type LotsByFollowedArtistsRailQuery$variables = {
  cursor?: string | null;
  count: number;
};
export type LotsByFollowedArtistsRailQueryVariables = LotsByFollowedArtistsRailQuery$variables;
export type LotsByFollowedArtistsRailQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"LotsByFollowedArtistsRail_me">;
  } | null;
};
export type LotsByFollowedArtistsRailQueryResponse = LotsByFollowedArtistsRailQuery$data;
export type LotsByFollowedArtistsRailQuery = {
  variables: LotsByFollowedArtistsRailQueryVariables;
  response: LotsByFollowedArtistsRailQuery$data;
};
