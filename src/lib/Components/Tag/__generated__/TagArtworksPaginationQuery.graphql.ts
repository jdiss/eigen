/**
 * @generated SignedSource<<3feee4b50d57b52a7aac0c6f01f01265>>
...
export type TagArtworksPaginationQueryVariables = TagArtworksPaginationQuery$variables;
export type TagArtworksPaginationQuery$data = {
  readonly tag: {
    readonly " $fragmentSpreads": FragmentRefs<"TagArtworks_tag">;
  } | null;
};
export type TagArtworksPaginationQueryResponse = TagArtworksPaginationQuery$data;
export type TagArtworksPaginationQuery = {
  variables: TagArtworksPaginationQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "fe9622eab26eb7dae78412098313809e",
    "id": null,
    "metadata": {},
    "name": "TagArtworksPaginationQuery",
    "operationKind": "query",
