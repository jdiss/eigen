/**
 * @generated SignedSource<<828f0ab2fc164c6917332ad6c38aa886>>
...
export type FilterModalTestsQuery$variables = {};
export type FilterModalTestsQueryVariables = FilterModalTestsQuery$variables;
export type FilterModalTestsQuery$data = {
  readonly marketingCollection: {
    readonly " $fragmentSpreads": FragmentRefs<"CollectionArtworks_collection">;
  } | null;
};
export type FilterModalTestsQueryResponse = FilterModalTestsQuery$data;
...
export type FilterModalTestsQueryRawResponse = FilterModalTestsQuery$rawResponse;
export type FilterModalTestsQuery = {
  variables: FilterModalTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "0ac9c4bbf04b60ebbe588bfb4536add5",
    "id": null,
    "metadata": {
