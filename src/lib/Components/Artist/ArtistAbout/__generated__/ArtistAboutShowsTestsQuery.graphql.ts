/**
 * @generated SignedSource<<a4c3ac7c45a32d1a33ba9e003152056a>>
...
export type ArtistAboutShowsTestsQuery$variables = {
  artistID: string;
};
export type ArtistAboutShowsTestsQueryVariables = ArtistAboutShowsTestsQuery$variables;
...
export type ArtistAboutShowsTestsQueryResponse = ArtistAboutShowsTestsQuery$data;
export type ArtistAboutShowsTestsQuery = {
  variables: ArtistAboutShowsTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "7675ceb9b827757d5e2bf572d0a525d5",
    "id": null,
    "metadata": {
