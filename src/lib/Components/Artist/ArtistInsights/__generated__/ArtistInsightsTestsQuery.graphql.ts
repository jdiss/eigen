/**
 * @generated SignedSource<<63299bbc97b0ccb047b54c79bb117dda>>
...
export type ArtistInsightsTestsQuery$variables = {};
export type ArtistInsightsTestsQueryVariables = ArtistInsightsTestsQuery$variables;
export type ArtistInsightsTestsQuery$data = {
  readonly artist: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtistInsights_artist">;
  } | null;
};
export type ArtistInsightsTestsQueryResponse = ArtistInsightsTestsQuery$data;
export type ArtistInsightsTestsQuery = {
  variables: ArtistInsightsTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "df45a067a2e1d0346f7564d69218f4ea",
    "id": null,
    "metadata": {
