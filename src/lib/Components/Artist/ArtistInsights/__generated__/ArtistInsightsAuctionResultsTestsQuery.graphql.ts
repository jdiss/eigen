/**
 * @generated SignedSource<<f063d36c29a493423265dcdae6949caa>>
...
export type ArtistInsightsAuctionResultsTestsQuery$variables = {};
export type ArtistInsightsAuctionResultsTestsQueryVariables = ArtistInsightsAuctionResultsTestsQuery$variables;
...
export type ArtistInsightsAuctionResultsTestsQueryResponse = ArtistInsightsAuctionResultsTestsQuery$data;
export type ArtistInsightsAuctionResultsTestsQuery = {
  variables: ArtistInsightsAuctionResultsTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "f455d6d671c4a0159a633b8db2ef2eca",
    "id": null,
    "metadata": {
