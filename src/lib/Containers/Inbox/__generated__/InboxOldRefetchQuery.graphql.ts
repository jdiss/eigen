/**
 * @generated SignedSource<<e78a2bf2912ce31355fc5095f05b3fe7>>
...
export type InboxOldRefetchQuery$variables = {};
export type InboxOldRefetchQueryVariables = InboxOldRefetchQuery$variables;
export type InboxOldRefetchQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"InboxOld_me">;
  } | null;
};
export type InboxOldRefetchQueryResponse = InboxOldRefetchQuery$data;
export type InboxOldRefetchQuery = {
  variables: InboxOldRefetchQueryVariables;
  response: InboxOldRefetchQuery$data;
};
