/**
 * @generated SignedSource<<c4ebd9ce4aaf44f9abc6c2fea0c7c729>>
...
export type InboxRefetchQuery$variables = {};
export type InboxRefetchQueryVariables = InboxRefetchQuery$variables;
export type InboxRefetchQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"Inbox_me">;
  } | null;
};
export type InboxRefetchQueryResponse = InboxRefetchQuery$data;
export type InboxRefetchQuery = {
  variables: InboxRefetchQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "327d556434679d48a8ac6397ed46ee60",
    "id": null,
    "metadata": {},
    "name": "InboxRefetchQuery",
    "operationKind": "query",
