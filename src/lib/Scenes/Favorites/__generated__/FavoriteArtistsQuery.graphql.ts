/**
 * @generated SignedSource<<0a1072fed98955b17aedc0d3d9b44ab7>>
...
export type FavoriteArtistsQuery$variables = {};
export type FavoriteArtistsQueryVariables = FavoriteArtistsQuery$variables;
export type FavoriteArtistsQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"FavoriteArtists_me">;
  } | null;
};
export type FavoriteArtistsQueryResponse = FavoriteArtistsQuery$data;
export type FavoriteArtistsQuery = {
  variables: FavoriteArtistsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "f672e4412ad35cb0d878082c9165effd",
    "id": null,
    "metadata": {},
    "name": "FavoriteArtistsQuery",
    "operationKind": "query",
