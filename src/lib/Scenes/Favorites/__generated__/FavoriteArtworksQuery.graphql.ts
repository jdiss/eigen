/**
 * @generated SignedSource<<91f42c48e1f47db50365ba99b717e893>>
...
export type FavoriteArtworksQuery$variables = {};
export type FavoriteArtworksQueryVariables = FavoriteArtworksQuery$variables;
export type FavoriteArtworksQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"FavoriteArtworks_me">;
  } | null;
};
export type FavoriteArtworksQueryResponse = FavoriteArtworksQuery$data;
export type FavoriteArtworksQuery = {
  variables: FavoriteArtworksQueryVariables;
  response: FavoriteArtworksQuery$data;
};
...
return {
  ...
  "params": {
    "cacheID": "3467bfc42bbbdd44b5385eb703e1729a",
    "id": null,
    "metadata": {},
    "name": "FavoriteArtworksQuery",
    "operationKind": "query",
