/**
 * @generated SignedSource<<55948fa017ef61239c8c760ff3e2d029>>
...
export type FavoriteCategoriesQuery$variables = {};
export type FavoriteCategoriesQueryVariables = FavoriteCategoriesQuery$variables;
export type FavoriteCategoriesQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"FavoriteCategories_me">;
  } | null;
};
export type FavoriteCategoriesQueryResponse = FavoriteCategoriesQuery$data;
export type FavoriteCategoriesQuery = {
  variables: FavoriteCategoriesQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "1f2fe351db671db305e2398c685053b7",
    "id": null,
    "metadata": {},
    "name": "FavoriteCategoriesQuery",
    "operationKind": "query",
