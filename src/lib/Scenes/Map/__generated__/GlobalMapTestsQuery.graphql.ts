/**
 * @generated SignedSource<<283b68b2c50d347b716383094bcad994>>
...
export type GlobalMapTestsQuery$variables = {
  citySlug: string;
  maxInt: number;
};
export type GlobalMapTestsQueryVariables = GlobalMapTestsQuery$variables;
export type GlobalMapTestsQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"GlobalMap_viewer">;
};
export type GlobalMapTestsQueryResponse = GlobalMapTestsQuery$data;
export type GlobalMapTestsQuery$rawResponse = {
  readonly city: {
...
export type GlobalMapTestsQueryRawResponse = GlobalMapTestsQuery$rawResponse;
export type GlobalMapTestsQuery = {
  variables: GlobalMapTestsQueryVariables;
  response: GlobalMapTestsQuery$data;
  rawResponse: GlobalMapTestsQuery$rawResponse;
};
...
return {
  ...
  "params": {
    "cacheID": "88418599ac9beda12124a76e60e95d1c",
    "id": null,
    "metadata": {},
    "name": "GlobalMapTestsQuery",
    "operationKind": "query",
