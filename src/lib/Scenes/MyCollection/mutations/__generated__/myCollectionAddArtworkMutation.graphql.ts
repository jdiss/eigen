/**
 * @generated SignedSource<<958acb80d7ef65d2565332def3f026de>>
...
export type myCollectionAddArtworkMutation$variables = {
  input: MyCollectionCreateArtworkInput;
};
export type myCollectionAddArtworkMutationVariables = myCollectionAddArtworkMutation$variables;
export type myCollectionAddArtworkMutation$data = {
...
export type myCollectionAddArtworkMutationResponse = myCollectionAddArtworkMutation$data;
export type myCollectionAddArtworkMutation = {
  variables: myCollectionAddArtworkMutationVariables;
  response: myCollectionAddArtworkMutation$data;
};
...
return {
  ...
  "params": {
    "cacheID": "2fba09faced9b5e1b32148bfe91d87cd",
    "id": null,
    "metadata": {},
    "name": "myCollectionAddArtworkMutation",
    "operationKind": "mutation",
    "text": "mutation myCollectionAddArtworkMutation(\n  $input: MyCollectionCreateArtworkInput!\n) {\n  myCollectionCreateArtwork(input: $input) {\n    artworkOrError {\n      __typename\n      ... on MyCollectionArtworkMutationSuccess {\n        artworkEdge {\n          node {\n            artist {\n              internalID\n              formattedNationalityAndBirthday\n              id\n            }\n            artistNames\n            category\n            pricePaid {\n              display\n              minor\n              currencyCode\n            }\n            date\n            depth\n            editionSize\n            editionNumber\n            height\n            attributionClass {\n              name\n              id\n            }\n            id\n            images {\n              isDefault\n              imageURL\n              width\n              height\n              internalID\n            }\n            internalID\n            isEdition\n            medium\n            metric\n            provenance\n            slug\n            title\n            width\n          }\n        }\n      }\n      ... on MyCollectionArtworkMutationFailure {\n        mutationError {\n          message\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();
