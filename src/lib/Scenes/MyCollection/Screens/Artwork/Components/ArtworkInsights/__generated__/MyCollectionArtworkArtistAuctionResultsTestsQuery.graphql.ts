/**
 * @generated SignedSource<<fdb645effb200f7449f61cd3e0a539ee>>
...
export type MyCollectionArtworkArtistAuctionResultsTestsQuery$variables = {};
export type MyCollectionArtworkArtistAuctionResultsTestsQueryVariables = MyCollectionArtworkArtistAuctionResultsTestsQuery$variables;
export type MyCollectionArtworkArtistAuctionResultsTestsQuery$data = {
  readonly artwork: {
    readonly " $fragmentSpreads": FragmentRefs<"MyCollectionArtworkArtistAuctionResults_artwork">;
  } | null;
};
export type MyCollectionArtworkArtistAuctionResultsTestsQueryResponse = MyCollectionArtworkArtistAuctionResultsTestsQuery$data;
export type MyCollectionArtworkArtistAuctionResultsTestsQuery = {
  variables: MyCollectionArtworkArtistAuctionResultsTestsQueryVariables;
  response: MyCollectionArtworkArtistAuctionResultsTestsQuery$data;
};
...
return {
  ...
  "params": {
    "cacheID": "6aeacf2bb7bdfac8a516a17343e709c2",
    "id": null,
    "metadata": {
