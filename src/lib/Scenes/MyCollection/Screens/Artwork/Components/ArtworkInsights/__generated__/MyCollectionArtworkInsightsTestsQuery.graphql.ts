/**
 * @generated SignedSource<<260fb9ce17cf7d885ce5a5d0dd2ca4e0>>
...
export type MyCollectionArtworkInsightsTestsQuery$variables = {};
export type MyCollectionArtworkInsightsTestsQueryVariables = MyCollectionArtworkInsightsTestsQuery$variables;
...
export type MyCollectionArtworkInsightsTestsQueryResponse = MyCollectionArtworkInsightsTestsQuery$data;
export type MyCollectionArtworkInsightsTestsQuery = {
  variables: MyCollectionArtworkInsightsTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "4d8fa5dcd2401df8920c4a676fe4deb8",
    "id": null,
    "metadata": {
