/**
 * @generated SignedSource<<cbfcfbaeb6907bf2170d4061b3857541>>
...
export type ArtworkAutosuggestResultsQueryVariables = ArtworkAutosuggestResultsQuery$variables;
export type ArtworkAutosuggestResultsQuery$data = {
  readonly viewer: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtworkAutosuggestResults_viewer">;
  } | null;
};
export type ArtworkAutosuggestResultsQueryResponse = ArtworkAutosuggestResultsQuery$data;
export type ArtworkAutosuggestResultsQuery = {
  variables: ArtworkAutosuggestResultsQueryVariables;
