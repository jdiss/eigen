/**
 * @generated SignedSource<<6808c6b0207d0f30c82866fe6632e02d>>
...
export type MyBidsRefetchQuery$variables = {};
export type MyBidsRefetchQueryVariables = MyBidsRefetchQuery$variables;
export type MyBidsRefetchQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"MyBids_me">;
  } | null;
};
export type MyBidsRefetchQueryResponse = MyBidsRefetchQuery$data;
export type MyBidsRefetchQuery = {
  variables: MyBidsRefetchQueryVariables;
