/**
 * @generated SignedSource<<582bd582038f1a3c539957648327d1bf>>
...
export type FullFeaturedArtistListQueryVariables = FullFeaturedArtistListQuery$variables;
export type FullFeaturedArtistListQuery$data = {
  readonly collection: {
    readonly " $fragmentSpreads": FragmentRefs<"FullFeaturedArtistList_collection">;
  } | null;
};
export type FullFeaturedArtistListQueryResponse = FullFeaturedArtistListQuery$data;
export type FullFeaturedArtistListQuery = {
  variables: FullFeaturedArtistListQueryVariables;
