/**
 * @generated SignedSource<<78f05147b74859101a5af16143c2b732>>
...
export type ArtistSeriesArtworksInfiniteScrollGridQueryVariables = ArtistSeriesArtworksInfiniteScrollGridQuery$variables;
...
export type ArtistSeriesArtworksInfiniteScrollGridQueryResponse = ArtistSeriesArtworksInfiniteScrollGridQuery$data;
export type ArtistSeriesArtworksInfiniteScrollGridQuery = {
  variables: ArtistSeriesArtworksInfiniteScrollGridQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "4a72de67cce90c921010aceab680d080",
    "id": null,
    "metadata": {},
    "name": "ArtistSeriesArtworksInfiniteScrollGridQuery",
    "operationKind": "query",
    "text": "query ArtistSeriesArtworksInfiniteScrollGridQuery(\n  $id: ID!\n  $count: Int!\n  $cursor: String\n  $input: FilterArtworksInput\n) {\n  artistSeries(id: $id) {\n    ...ArtistSeriesArtworks_artistSeries_YCAiB\n  }\n}\n\nfragment ArtistSeriesArtworks_artistSeries_YCAiB on ArtistSeries {\n  slug\n  internalID\n  artistSeriesArtworks: filterArtworksConnection(first: $count, after: $cursor, aggregations: [COLOR, DIMENSION_RANGE, LOCATION_CITY, MAJOR_PERIOD, MATERIALS_TERMS, MEDIUM, PARTNER, PRICE_RANGE], input: $input) {\n    aggregations {\n      slice\n      counts {\n        count\n        name\n        value\n      }\n    }\n    edges {\n      node {\n        id\n        __typename\n      }\n      cursor\n    }\n    counts {\n      total\n    }\n    ...InfiniteScrollArtworksGrid_connection\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    id\n  }\n}\n\nfragment ArtworkGridItem_artwork on Artwork {\n  title\n  date\n  saleMessage\n  slug\n  internalID\n  artistNames\n  href\n  sale {\n    isAuction\n    isClosed\n    displayTimelyAt\n    endAt\n    id\n  }\n  saleArtwork {\n    counts {\n      bidderPositions\n    }\n    currentBid {\n      display\n    }\n    lotLabel\n    id\n  }\n  partner {\n    name\n    id\n  }\n  image {\n    url(version: \"large\")\n    aspectRatio\n  }\n}\n\nfragment InfiniteScrollArtworksGrid_connection on ArtworkConnectionInterface {\n  __isArtworkConnectionInterface: __typename\n  pageInfo {\n    hasNextPage\n    startCursor\n    endCursor\n  }\n  edges {\n    __typename\n    node {\n      slug\n      id\n      image {\n        aspectRatio\n      }\n      ...ArtworkGridItem_artwork\n    }\n    ... on Node {\n      __isNode: __typename\n      id\n    }\n  }\n}\n"
  }
};
})();
