/**
 * @generated SignedSource<<25eebdbd1e63dab4ff35ae26733be636>>
...
export type AuctionResultsRailTestsQuery$variables = {};
export type AuctionResultsRailTestsQueryVariables = AuctionResultsRailTestsQuery$variables;
export type AuctionResultsRailTestsQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"AuctionResultsRail_me">;
  } | null;
};
export type AuctionResultsRailTestsQueryResponse = AuctionResultsRailTestsQuery$data;
...
export type AuctionResultsRailTestsQueryRawResponse = AuctionResultsRailTestsQuery$rawResponse;
export type AuctionResultsRailTestsQuery = {
  variables: AuctionResultsRailTestsQueryVariables;
