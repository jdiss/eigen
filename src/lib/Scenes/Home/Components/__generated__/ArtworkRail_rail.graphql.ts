/**
 * @generated SignedSource<<b11a2f5cd87594a59b30bd2b1be97b11>>
...
export type ArtworkRail_rail$data = {
  readonly title: string | null;
  readonly key: string | null;
  readonly results: ReadonlyArray<{
    readonly " $fragmentSpreads": FragmentRefs<"SmallTileRail_artworks" | "GenericGrid_artworks">;
  } | null> | null;
  readonly context: {
  ...
  readonly " $fragmentType": "ArtworkRail_rail";
};
export type ArtworkRail_rail = ArtworkRail_rail$data;
