/**
 * @generated SignedSource<<4e4093a9d20188b357b0a8d28b3cef20>>
...
export type HomeHero_homePage$data = {
  ...
  readonly " $fragmentType": "HomeHero_homePage";
};
export type HomeHero_homePage = HomeHero_homePage$data;
