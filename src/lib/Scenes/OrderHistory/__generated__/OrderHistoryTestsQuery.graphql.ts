/**
 * @generated SignedSource<<1c23398feba37d33ca108b66762e2206>>
...
export type OrderHistoryTestsQueryVariables = OrderHistoryTestsQuery$variables;
export type OrderHistoryTestsQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"OrderHistory_me">;
  } | null;
};
export type OrderHistoryTestsQueryResponse = OrderHistoryTestsQuery$data;
export type OrderHistoryTestsQuery = {
  variables: OrderHistoryTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "85e412a5fba4fafdf2b2e4d7c399d57b",
    "id": null,
    "metadata": {
