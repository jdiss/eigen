/**
 * @generated SignedSource<<919e1b38076953e4ae1949a16b81cf76>>
...
export type SaleLotsList_saleArtworksConnection$data = {
  readonly saleArtworksConnection: {
    ...
    readonly " $fragmentSpreads": FragmentRefs<"SaleArtworkList_connection" | "InfiniteScrollArtworksGrid_connection">;
  } | null;
  readonly " $fragmentType": "SaleLotsList_saleArtworksConnection";
};
export type SaleLotsList_saleArtworksConnection = SaleLotsList_saleArtworksConnection$data;
