/**
 * @generated SignedSource<<40329fce23bf4f32d734fcfe9d51044f>>
...
export type PartnerArtworkInfiniteScrollGridQueryVariables = PartnerArtworkInfiniteScrollGridQuery$variables;
export type PartnerArtworkInfiniteScrollGridQuery$data = {
  readonly partner: {
    readonly " $fragmentSpreads": FragmentRefs<"PartnerArtwork_partner">;
  } | null;
};
export type PartnerArtworkInfiniteScrollGridQueryResponse = PartnerArtworkInfiniteScrollGridQuery$data;
export type PartnerArtworkInfiniteScrollGridQuery = {
  variables: PartnerArtworkInfiniteScrollGridQueryVariables;
