/**
 * @generated SignedSource<<283c427f495fa10535a1a84999977669>>
...
export type FairExhibitorsQueryVariables = FairExhibitorsQuery$variables;
export type FairExhibitorsQuery$data = {
  readonly fair: {
    readonly " $fragmentSpreads": FragmentRefs<"FairExhibitors_fair">;
  } | null;
};
export type FairExhibitorsQueryResponse = FairExhibitorsQuery$data;
export type FairExhibitorsQuery = {
  variables: FairExhibitorsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "1047ebeb79bdb02be095c7f089fc4e80",
    "id": null,
    "metadata": {},
    "name": "FairExhibitorsQuery",
    "operationKind": "query",
