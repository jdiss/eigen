/**
 * @generated SignedSource<<d226e203f99444abb2588d00883a030f>>
...
export type FairTestsQueryVariables = FairTestsQuery$variables;
export type FairTestsQuery$data = {
  readonly fair: {
    readonly " $fragmentSpreads": FragmentRefs<"Fair_fair">;
  } | null;
};
export type FairTestsQueryResponse = FairTestsQuery$data;
export type FairTestsQuery = {
  variables: FairTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "c6ece6f11db50f40a0c441a91bc0b645",
    "id": null,
    "metadata": {
