/**
 * @generated SignedSource<<7a0b4aafb234d7592e9fe5ff5c045fe0>>
...
export type FairQueryVariables = FairQuery$variables;
export type FairQuery$data = {
  readonly fair: {
    readonly " $fragmentSpreads": FragmentRefs<"Fair_fair">;
  } | null;
};
export type FairQueryResponse = FairQuery$data;
export type FairQuery = {
  variables: FairQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "3b68c7082b25465b8c1af678fd1288f2",
    "id": null,
    "metadata": {},
    "name": "FairQuery",
    "operationKind": "query",
