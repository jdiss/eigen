/**
 * @generated SignedSource<<ba75149f31f103d45f2da20a23e4e07e>>
...
export type FairArticlesQueryVariables = FairArticlesQuery$variables;
export type FairArticlesQuery$data = {
  readonly fair: {
    readonly " $fragmentSpreads": FragmentRefs<"FairArticles_fair">;
  } | null;
};
export type FairArticlesQueryResponse = FairArticlesQuery$data;
export type FairArticlesQuery = {
  variables: FairArticlesQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "87d2388264c700fee7dfa6e461a57302",
    "id": null,
    "metadata": {},
    "name": "FairArticlesQuery",
    "operationKind": "query",
