/**
 * @generated SignedSource<<9c15061c7871305d48e3349113c75744>>
...
export type updateConsignmentSubmissionMutation$variables = {
  input: UpdateSubmissionMutationInput;
};
export type updateConsignmentSubmissionMutationVariables = updateConsignmentSubmissionMutation$variables;
export type updateConsignmentSubmissionMutation$data = {
...
export type updateConsignmentSubmissionMutationResponse = updateConsignmentSubmissionMutation$data;
export type updateConsignmentSubmissionMutation = {
  variables: updateConsignmentSubmissionMutationVariables;
  response: updateConsignmentSubmissionMutation$data;
};
...
return {
  ...
  "params": {
    "cacheID": "27f3c226b08051fc14a0ffbdb4c96b5c",
    "id": null,
    "metadata": {},
    "name": "updateConsignmentSubmissionMutation",
    "operationKind": "mutation",
    "text": "mutation updateConsignmentSubmissionMutation(\n  $input: UpdateSubmissionMutationInput!\n) {\n  updateConsignmentSubmission(input: $input) {\n    consignmentSubmission {\n      internalID\n      id\n    }\n  }\n}\n"
  }
};
})();
