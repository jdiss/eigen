/**
 * @generated SignedSource<<1d89f33455dab577f89b5089216a13ef>>
...
export type CityBMWList_city$data = {
  ...
  readonly " $fragmentType": "CityBMWList_city";
};
export type CityBMWList_city = CityBMWList_city$data;
