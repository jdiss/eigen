/**
 * @generated SignedSource<<3178189b2834da37d9cb169208b8d410>>
...
export type ShowTestsQueryVariables = ShowTestsQuery$variables;
export type ShowTestsQuery$data = {
  readonly show: {
    readonly " $fragmentSpreads": FragmentRefs<"Show_show">;
  } | null;
};
export type ShowTestsQueryResponse = ShowTestsQuery$data;
export type ShowTestsQuery = {
  variables: ShowTestsQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "27856e34cc439060191ae665aafb665b",
    "id": null,
    "metadata": {
