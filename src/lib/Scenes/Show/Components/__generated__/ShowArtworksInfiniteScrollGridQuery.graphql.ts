/**
 * @generated SignedSource<<c04c9a518bda6a3355e1c287a4c3363a>>
...
export type ShowArtworksInfiniteScrollGridQueryVariables = ShowArtworksInfiniteScrollGridQuery$variables;
export type ShowArtworksInfiniteScrollGridQuery$data = {
  readonly show: {
    readonly " $fragmentSpreads": FragmentRefs<"ShowArtworks_show">;
  } | null;
};
export type ShowArtworksInfiniteScrollGridQueryResponse = ShowArtworksInfiniteScrollGridQuery$data;
export type ShowArtworksInfiniteScrollGridQuery = {
  variables: ShowArtworksInfiniteScrollGridQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "399c20b46e483c352c11611a58a507a5",
    "id": null,
    "metadata": {},
    "name": "ShowArtworksInfiniteScrollGridQuery",
    "operationKind": "query",
    "text": "query ShowArtworksInfiniteScrollGridQuery(\n  $id: String!\n  $count: Int!\n  $cursor: String\n  $input: FilterArtworksInput\n) {\n  show(id: $id) {\n    ...ShowArtworks_show_YCAiB\n    id\n  }\n}\n\nfragment ArtworkGridItem_artwork on Artwork {\n  title\n  date\n  saleMessage\n  slug\n  internalID\n  artistNames\n  href\n  sale {\n    isAuction\n    isClosed\n    displayTimelyAt\n    endAt\n    id\n  }\n  saleArtwork {\n    counts {\n      bidderPositions\n    }\n    currentBid {\n      display\n    }\n    lotLabel\n    id\n  }\n  partner {\n    name\n    id\n  }\n  image {\n    url(version: \"large\")\n    aspectRatio\n  }\n}\n\nfragment InfiniteScrollArtworksGrid_connection on ArtworkConnectionInterface {\n  __isArtworkConnectionInterface: __typename\n  pageInfo {\n    hasNextPage\n    startCursor\n    endCursor\n  }\n  edges {\n    __typename\n    node {\n      slug\n      id\n      image {\n        aspectRatio\n      }\n      ...ArtworkGridItem_artwork\n    }\n    ... on Node {\n      __isNode: __typename\n      id\n    }\n  }\n}\n\nfragment ShowArtworks_show_YCAiB on Show {\n  slug\n  internalID\n  showArtworks: filterArtworksConnection(first: $count, after: $cursor, aggregations: [ARTIST, ARTIST_NATIONALITY, COLOR, DIMENSION_RANGE, FOLLOWED_ARTISTS, MAJOR_PERIOD, MATERIALS_TERMS, MEDIUM, PRICE_RANGE], input: $input) {\n    aggregations {\n      slice\n      counts {\n        count\n        name\n        value\n      }\n    }\n    edges {\n      node {\n        id\n        __typename\n      }\n      cursor\n    }\n    counts {\n      total\n    }\n    ...InfiniteScrollArtworksGrid_connection\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    id\n  }\n}\n"
  }
};
})();
