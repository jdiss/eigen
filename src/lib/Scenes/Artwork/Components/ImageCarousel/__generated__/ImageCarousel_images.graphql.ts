/**
 * @generated SignedSource<<338d26eae5297d92d554c57ec6ecee62>>
...
export type ImageCarousel_images$data = ReadonlyArray<{
  ...
  readonly " $fragmentType": "ImageCarousel_images";
}>;
export type ImageCarousel_images = ImageCarousel_images$data;
