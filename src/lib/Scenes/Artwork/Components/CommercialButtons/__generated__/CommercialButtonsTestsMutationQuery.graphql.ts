/**
 * @generated SignedSource<<0e09ef55a88cccb83549ff136bf0e00e>>
...
export type CommercialButtonsTestsMutationQuery$variables = {};
export type CommercialButtonsTestsMutationQueryVariables = CommercialButtonsTestsMutationQuery$variables;
export type CommercialButtonsTestsMutationQuery$data = {
  readonly artwork: {
    readonly " $fragmentSpreads": FragmentRefs<"CommercialButtons_artwork">;
  } | null;
};
export type CommercialButtonsTestsMutationQueryResponse = CommercialButtonsTestsMutationQuery$data;
export type CommercialButtonsTestsMutationQuery$rawResponse = {
  readonly artwork: {
...
export type CommercialButtonsTestsMutationQueryRawResponse = CommercialButtonsTestsMutationQuery$rawResponse;
export type CommercialButtonsTestsMutationQuery = {
  variables: CommercialButtonsTestsMutationQueryVariables;
  response: CommercialButtonsTestsMutationQuery$data;
  rawResponse: CommercialButtonsTestsMutationQuery$rawResponse;
};
