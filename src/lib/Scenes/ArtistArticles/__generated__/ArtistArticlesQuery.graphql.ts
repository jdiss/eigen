/**
 * @generated SignedSource<<c9bcfc7f51b06648070e42ff22abe124>>
...
export type ArtistArticlesQueryVariables = ArtistArticlesQuery$variables;
export type ArtistArticlesQuery$data = {
  readonly artist: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtistArticles_artist">;
  } | null;
};
export type ArtistArticlesQueryResponse = ArtistArticlesQuery$data;
export type ArtistArticlesQuery = {
  variables: ArtistArticlesQueryVariables;
...
return {
  ...
  "params": {
    "cacheID": "0e8126788ad58ec983153c12a2ac1c24",
    "id": null,
    "metadata": {},
    "name": "ArtistArticlesQuery",
    "operationKind": "query",
