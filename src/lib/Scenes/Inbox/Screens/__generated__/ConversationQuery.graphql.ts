/**
 * @generated SignedSource<<f269dfe37c419eea573e66ab5afe3894>>
...
export type ConversationQueryVariables = ConversationQuery$variables;
export type ConversationQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"Conversation_me">;
  } | null;
};
export type ConversationQueryResponse = ConversationQuery$data;
...
return {
  ...
  "params": {
    "cacheID": "be4ad86be3187ab1bfae0a3586cb2272",
    "id": null,
    "metadata": {},
    "name": "ConversationQuery",
    "operationKind": "query",
