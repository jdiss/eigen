/**
 * @generated SignedSource<<117d810240d0392a896e25b1b97d41e1>>
...
export type ActiveBidsRefetchQuery$variables = {};
export type ActiveBidsRefetchQueryVariables = ActiveBidsRefetchQuery$variables;
export type ActiveBidsRefetchQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"ActiveBids_me">;
  } | null;
};
export type ActiveBidsRefetchQueryResponse = ActiveBidsRefetchQuery$data;
export type ActiveBidsRefetchQuery = {
  variables: ActiveBidsRefetchQueryVariables;
  response: ActiveBidsRefetchQuery$data;
};
...
return {
  ...
  "params": {
    "cacheID": "8d5a4748dd2ad464ff59d390f6186cd5",
    "id": null,
    "metadata": {},
    "name": "ActiveBidsRefetchQuery",
    "operationKind": "query",
