/**
 * @generated SignedSource<<ee467619c9c6f5499413b2d70d613977>>
...
export type AuctionResultTestsQuery$variables = {
  auctionResultInternalID: string;
  artistID: string;
};
export type AuctionResultTestsQueryVariables = AuctionResultTestsQuery$variables;
export type AuctionResultTestsQuery$data = {
...
export type AuctionResultTestsQueryResponse = AuctionResultTestsQuery$data;
export type AuctionResultTestsQuery = {
  variables: AuctionResultTestsQueryVariables;
  response: AuctionResultTestsQuery$data;
};
...
return {
  ...
  "params": {
    "cacheID": "947483109386ad8ff7057bbd29f7da2b",
    "id": null,
    "metadata": {
