/**
 * @generated SignedSource<<9889985fa4d72aea4a623c39b30c1c52>>
...
export type MyProfile_me$data = {
  ...
  readonly " $fragmentType": "MyProfile_me";
};
export type MyProfile_me = MyProfile_me$data;
