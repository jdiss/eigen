/**
 * @generated SignedSource<<acc43767f8d2e0eaed2cd2b3242be35d>>
...
export type MyProfileQueryVariables = MyProfileQuery$variables;
export type MyProfileQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"MyProfile_me">;
  } | null;
};
export type MyProfileQueryResponse = MyProfileQuery$data;
...
return {
  ...
  "params": {
    "cacheID": "e8de7c8abc1c8f039996326abc785179",
    "id": null,
    "metadata": {},
    "name": "MyProfileQuery",
    "operationKind": "query",
