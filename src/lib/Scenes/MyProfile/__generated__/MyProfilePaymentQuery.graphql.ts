/**
 * @generated SignedSource<<c5a87c4bb3fcde3b1e1c7c92d0ab127b>>
...
export type MyProfilePaymentQueryVariables = MyProfilePaymentQuery$variables;
export type MyProfilePaymentQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"MyProfilePayment_me">;
  } | null;
};
export type MyProfilePaymentQueryResponse = MyProfilePaymentQuery$data;
export type MyProfilePaymentQuery = {
  variables: MyProfilePaymentQueryVariables;
