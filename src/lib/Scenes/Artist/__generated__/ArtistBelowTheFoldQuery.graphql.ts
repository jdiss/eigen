/**
 * @generated SignedSource<<14a0bfc4fc6e7414a7b4e4005dd9b3eb>>
...
export type ArtistBelowTheFoldQueryVariables = ArtistBelowTheFoldQuery$variables;
export type ArtistBelowTheFoldQuery$data = {
  readonly artist: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtistAbout_artist" | "ArtistInsights_artist">;
  } | null;
};
export type ArtistBelowTheFoldQueryResponse = ArtistBelowTheFoldQuery$data;
export type ArtistBelowTheFoldQuery = {
  variables: ArtistBelowTheFoldQueryVariables;
